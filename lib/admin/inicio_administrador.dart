...
import 'package:present_now/admin/revision_entrada_maestros.dart';
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ListAsistenciaMaestros()),
                  );
                },
                ...
                child: const Text('Revision Entrada Maestros',
                    style: TextStyle(color: Colors.blue)),
                style: ElevatedButton.styleFrom(
                  foregroundColor: Colors.transparent,
                  backgroundColor: Colors.transparent,
